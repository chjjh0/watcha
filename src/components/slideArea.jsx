...
class slideArea extends Component {
    ...
    changeSlide(...num) {
        var title = this.slideArray[num[0]].title;
        var ratingValue = this.slideArray[num[0]].ratingValue;
        var rating = this.slideArray[num[0]].rating;
        var synopsis = this.slideArray[num[0]].synopsis;
        $(function(){
